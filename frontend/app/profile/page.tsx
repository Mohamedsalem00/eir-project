...
import { ConfirmationModal } from '../../src/components/ui/ConfirmationModal' // 1. Import the modal
...
export default function ProfilePage() {
  ...
  const [showLogoutConfirm, setShowLogoutConfirm] = useState(false) // 2. Add state for the modal
  ...
  // 3. Create functions to handle the modal flow
  ...
  if (!user) return null
  if (!allowedTypes.includes(userType)) return <AccessDenied />
  if (isUnauthorized) return <Unauthorized401 />
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
              ...
              <div className="px-6 sm:px-8 lg:px-12 py-8 sm:py-12">
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 sm:gap-8">
                  ...
                  <div className="flex-1 text-center sm:text-left">
                    ...
                    <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 mb-3">{profileData?.email || user.email}</p>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                <div className="px-6 sm:px-8 py-6 border-b border-gray-200 dark:border-gray-700">
                  <h2 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-gray-100 flex items-center gap-3">
                    <div className="h-8 w-8 rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center">
                      <svg className="h-4 w-4 text-gray-600 dark:text-gray-400" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                  ...
                  <div className="p-6 sm:p-8">
                    <div className="flex flex-wrap gap-3">
                      {profileData.permissions.map((permission, index) => (
                        <span key={index} className="inline-flex items-center px-4 py-2 bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-200 text-sm font-medium rounded-lg border border-gray-200 dark:border-gray-600">
                          <svg className="h-3 w-3 mr-2 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="space-y-8">
              ...
              {profileData?.statistiques && (
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                  <div className="px-6 py-6 border-b border-gray-200 dark:border-gray-700">
                    <h2 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100 flex items-center gap-3">
                      <div className="h-8 w-8 rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center">
                        <svg className="h-4 w-4 text-gray-600 dark:text-gray-400" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                ...
                <div className="p-6 space-y-3">
                  ...
                  <ActionButton 
                    onClick={handleLogoutClick} // 4. Update the onClick handler
                    variant="danger"
                    icon={
                      <svg className="h-4 w-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
      ...
      {/* 5. Add the modal component to the page */}
      <ConfirmationModal
        t={t}
...
function ProfileField({ label, value, icon }: ProfileFieldProps) {
  return (
    <div className="group">
      ...
      <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg px-4 py-3 group-hover:bg-gray-100 dark:group-hover:bg-gray-700 transition-colors">
...
function StatCard({ value, label, icon }: StatCardProps) {
  return (
    <div className="p-4 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
...
function ActionButton({ onClick, variant, icon, children }: ActionButtonProps) {
  const variantClasses = {
    primary: 'bg-gray-900 hover:bg-gray-800 text-white dark:bg-gray-100 dark:hover:bg-gray-200 dark:text-gray-900',
    secondary: 'bg-gray-100 hover:bg-gray-200 text-gray-700 border border-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-200 dark:border-gray-600',
